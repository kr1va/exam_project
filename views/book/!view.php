...
<!--            <div class="product-name">Name: --><?//=$book['name']?><!--</div>-->
            <div class="product-author">Автор: <?=$book['author']?></div>
    ...
    <div class="product card bg-white border-0 shadow" style="height: 400px;">
        ...
        <div class="card-body">
            <div class="list-group text-right">
                ...
                <div class="product-author card-text "><?=$book['author']?></div>
                ...
                <div class="product-buttons row position-bottom">
                    ...
                    <div class="col-6 ">
                        <a href="<?= URL::to(['book/index', 'name'=>$book['link_name']]) ?>"  class="btn btn-outline-primary product-button__more w-100">
